        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        A decent amount of attempts or gameplay before the completion.
                    </p>
                    <p>
                        The End Screen needs to be shown entirely.
                    </p>
                    <p>
                        For Geode players, use a mod menu with a cheat indicator and make sure to display it when beating a level.
                    </p>
                    <p>
                        Run stats, you either can show fps/tps and cps counters using a mod or the integrated debug setting called “show info label”, records ignoring this will be rejected.
                    </p>
                    <p>
                        Vanilla players are always required to show that they are not using geode in the same recording as the completion.
                    </p>
                    <p>
                        Clicks are REQUIRED for Insane demons and Extreme demons.
                    </p>
                    <p>
